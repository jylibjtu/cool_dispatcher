...
from config.config_and_register import get_logger, business_register_table, watcher_dict, acl_ips as ACL, port_dict, zk, zk_app_name, zk_module_name_web, handler_dict
...
@cli.command()
@click.option('-t', '--target', prompt='Target model name from [{}]'.format(business_register_table), help='Target name')
